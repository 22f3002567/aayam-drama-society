...
// // //         {[
// // //           { label: "Active Members", value: "42", icon: Users, color: "text-blue-400" },
// // //           { label: "Upcoming Events", value: "03", icon: Calendar, color: "text-gold-400" },
// // //           { label: "Certificates Minted", value: "156", icon: Award, color: "text-purple-400" },
// // //           { label: "System Status", value: "OPTIMAL", icon: Activity, color: "text-green-400" },
// // //         ].map((stat, i) => (
...
// // //         <h3 className="font-serif text-xl text-white mb-6">System Log</h3>
// // //         <div className="space-y-4">
// // //             <div className="flex items-center gap-4 text-sm border-b border-white/5 pb-4">
// // //                 <span className="font-mono text-xs text-red-500">10:42 AM</span>
// // //                 <span className="text-white/60">New production "The Crucible" added to Timeline.</span>
// // //             </div>
// // //             <div className="flex items-center gap-4 text-sm border-b border-white/5 pb-4">
// // //                 <span className="font-mono text-xs text-gold-500">09:15 AM</span>
// // //                 <span className="text-white/60">Certificate AYM-2026-004 generated by Admin.</span>
// // //             </div>
// // //             <div className="flex items-center gap-4 text-sm pb-2">
// // //                 <span className="font-mono text-xs text-blue-500">YESTERDAY</span>
// // //                 <span className="text-white/60">New member application received (Siddharth).</span>
// // //             </div>
// // //         </div>
// // //       </div>
...
// //       {/* SYSTEM LOGS (Placeholder for Phase 2) */}
// //       <div className="bg-[#0a0a0a] border border-white/5 rounded-xl p-8">
...
// //                     <span className="text-white/60">System initialized. Waiting for admin command.</span>
// //                 </div>
// //             ))}
// //         </div>
// //       </div>
