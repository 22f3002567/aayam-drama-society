...
// // //   activeRasa: RasaConfig;            // The current mood of the room
// // //   hoveredPlayId: string | null;      // Which play is being looked at
// // //   setFocus: (playId: string | null, rasa: RasaConfig | null) => void;
// // // };
...
// // //   const setFocus = (playId: string | null, rasa: RasaConfig | null) => {
// // //     setHoveredPlayId(playId);
// // //     // If we lose focus, revert to Default (Gold), else set the new Rasa
// // //     setActiveRasa(rasa || DEFAULT_RASA);
// // //   };

// // //   return (
// // //     <ArchiveContext.Provider value={{ activeRasa, hoveredPlayId, setFocus }}>
// // //       {children}
...
// //   hoveredPlay: Play | null; // We store the whole object now
...
// //   return (
// //     <ArchiveContext.Provider value={{ activeRasa, hoveredPlay, setFocus }}>
// //       {children}
// //     </ArchiveContext.Provider>
// //   );
// // }
