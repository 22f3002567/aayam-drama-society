...
// // //   return (
// // //     <div className="w-full max-w-7xl mx-auto px-6 md:px-12 mb-24">
// // //       <div className="text-[10px] uppercase tracking-[0.3em] text-gold-500 mb-8 flex items-center gap-4">
...
// // //           return (
// // //             <Link key={i} href={`/artist/${person.slug}`} className="group block">
// // //               {/* MEMBER CARD */}
// // //               <div className="flex items-center gap-4">
                
// // //                 {/* AVATAR */}
// // //                 <div className="relative w-12 h-12 rounded-full overflow-hidden border border-white/10 group-hover:border-gold-500 transition-colors">
// // //                   {person.image_url ? (
// // //                     <Image 
...
// // //                     />
// // //                   ) : (
// // //                     <div className="w-full h-full bg-neutral-900 flex items-center justify-center text-xs text-white/20">
...
// // //                   <span className="text-sm font-serif text-white/80 group-hover:text-white transition-colors">
// // //                     {person.name}
// // //                   </span>
// // //                   <span className="text-[9px] uppercase tracking-wider text-gold-500/60 group-hover:text-gold-500 transition-colors">
// // //                     {credit.role_artist || credit.role}
// // //                   </span>
// // //                 </div>
...
// //   // LOGIC: Sort credits to put 'Director' and 'Writer' first (Hierarchy of Creation)
...
// //   return (
// //     <section className="w-full max-w-[1400px] mx-auto px-6 md:px-12 mb-32 border-t border-white/5 pt-20">
...
// //             <span className="text-white/30 font-serif italic text-lg">
// //                 {credits.length} Artists involved
// //             </span>
// //         </div>
// //       </div>

// //       {/* THE GRID: Cinematic Vertical Cards */}
// //       <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-x-6 gap-y-16">
...
// //                     <div className="relative aspect-[2/3] overflow-hidden bg-[#0a0a0a] mb-5 border border-white/5 group-hover:border-gold-500/30 transition-colors duration-500">
// //                         {person.image_url ? (
// //                             <Image 
// //                                 src={person.image_url} 
// //                                 alt={person.name} 
...
// //                                 <span className="text-[9px] uppercase tracking-widest text-white">View Artist</span>
// //                              </div>
// //                         </div>
// //                     </div>
...
// //                         <span className="text-lg md:text-xl font-serif text-white/80 group-hover:text-white transition-colors leading-none">
// //                             {person.name}
// //                         </span>
// //                     </div>
