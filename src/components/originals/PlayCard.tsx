...
// // //   // Logic: Am I the one being hovered? Or is someone else?
...
// // //         onMouseEnter={() => {
// // //             playSound('hover');
// // //             setFocus(play, rasa); // "I am the Captain now"
// // //         }}
// // //         onMouseLeave={() => {
// // //             setFocus(null, null); // "Release focus"
// // //         }}
// // //       >
// // //         {/* THE POSTER FRAME */}
// // //         <div 
// // //             className="relative w-full aspect-[2/3] overflow-hidden rounded-sm bg-neutral-900 transition-all duration-700 ease-out"
// // //             style={{ 
// // //                boxShadow: isHovered ? `0 20px 50px -10px ${rasa.color}40` : 'none' // Colored shadow on hover
// // //             }}
// // //         >
// // //           {/* Border that lights up */}
// // //           <div 
// // //             className="absolute inset-0 border-2 opacity-0 transition-opacity duration-500 z-20 pointer-events-none rounded-sm"
// // //             style={{ 
...
// // //               alt={play.title}
// // //               fill
// // //               className="object-cover opacity-80 grayscale transition-all duration-700"
// // //               style={{
...
// // //              <h3 className="text-xl font-serif text-neutral-300 transition-colors" 
// // //                  style={{ color: isHovered ? '#FFFFFF' : undefined }}>
// // //                 {play.title}
// // //              </h3>
// // //              <span className="text-[10px] font-mono text-neutral-600 transition-colors"
...
// // //             <span 
// // //                 className="text-[9px] uppercase tracking-widest text-neutral-500 transition-colors"
// // //                 style={{ color: isHovered ? rasa.color : undefined }}
// // //             >
// // //                 {rasa.label}
// // //             </span>
...
// //             className="relative w-full aspect-[2/3] overflow-hidden rounded-sm bg-neutral-900 transition-all duration-700 ease-out"
// //             style={{ 
// //                boxShadow: isHovered ? `0 20px 50px -10px ${rasa.color}20` : 'none'
// //             }}
// //         >
// //           {/* 1. BORDER GLOW */}
// //           <div 
...
// //           {/* 2. THE STORY (The Whisper) - NEW FEATURE */}
// //           {/* Sits on top of image, hidden by default */}
// //           <div className="absolute inset-0 z-30 flex flex-col justify-end p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
// //              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/80 to-transparent" />
             
// //              <div className="relative z-40 flex flex-col gap-3 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
// //                 <span className="text-[10px] uppercase tracking-widest" style={{ color: rasa.color }}>
// //                     {rasa.label}
// //                 </span>
...
// //                     <span className="text-[9px] uppercase tracking-widest text-white border-b border-white/30 pb-0.5">Watch Production</span>
...
// //               style={{
// //                   opacity: isHovered ? 0.4 : 0.8, // Darkens on hover to let text pop
// //                   filter: isHovered ? 'grayscale(0%)' : 'grayscale(100%)',
// //                   transform: isHovered ? 'scale(1.05)' : 'scale(1)'
// //               }}
// //             />
...
// //         <div className="flex flex-col gap-1 px-1">
// //           <div className="flex justify-between items-baseline">
// //              <h3 className="text-lg font-serif text-neutral-400 transition-colors duration-300" 
// //                  style={{ color: isHovered ? '#FFFFFF' : undefined }}>
// //                 {play.title}
// //              </h3>
